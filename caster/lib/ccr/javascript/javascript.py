...
class Javascript(MergeRule):
    ...
    mapping = {
        ...
        SymbolSpecs.FOR_LOOP:           R(Text("for (var i=0; i<TOKEN; i++)"), rdescript="Javascript: For i Loop"),
        SymbolSpecs.FOR_EACH_LOOP:      R(Text("for (TOKEN in TOKEN)"), rdescript="Javascript: For Each Loop"),
        #
        ...
        # 
        SymbolSpecs.FUNCTION:           R(Text("function TOKEN() {};") + Key("left:2, enter")
