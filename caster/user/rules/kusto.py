...
class KustoRule(MergeRule):
  ...
  mapping = {    
    ...
    "target":            R(Text("targetUri"), rdescript="Kusto: targetUri"),
    ...
    "incoming":      R(Text("HttpIncomingRequestsAll"), rdescript="Kusto: HttpIncomingRequests"),
    "outgoing":      R(Text("HttpOutgoingRequestsAll"), rdescript="Kusto: HttpOutgoingRequests"),
